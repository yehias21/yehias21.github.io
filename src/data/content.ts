...
// ---------------------------------------------------------------------------
// Idea garden: half-formed research and business ideas.
//
...
// history of this file (linked from the Ideas tabs), so the dated commits are
// the real proof of timestamp.
//
// To add an idea: prepend an entry (newest first). To edit one: change the
// body/pitch AND prepend a revision note with today's date. Business ideas
// (category: 'business') are shown publicly but are dated, version-controlled,
// and, where marked `patentPending`, protected. The licensing and citation
// notice on the Business tab governs reuse.
//
// (Seed placeholders removed. Add your own entries below.)
